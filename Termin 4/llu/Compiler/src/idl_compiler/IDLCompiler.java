...
public class IDLCompiler {
	...
	static class MethodData {
		 ...
		 */
		private MethodeParamData[] paramTypes;
		
		public MethodData(String name, SupportedDataTypes returnType, MethodeParamData[] paramTypes2) {
			this.name = name;
		 ...
		 * @uml.property  name="paramTypes"
		 */
		public MethodeParamData[] getParamTypes() {
			return paramTypes;
		}		
	}
