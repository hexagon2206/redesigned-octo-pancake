...
public class ObjectBroker {
	...
	private ObjectBroker(InetAddress localAddres,int myPort) throws IOException{
	...
	private ObjectBroker(InetAddress localAddres,String server,int port,int myPort) throws IOException{
	...
	public static ObjectBroker init(InetAddress localAddres,String serviceHost, int listenPort, int myPort,boolean debug) throws IOException{
		return new ObjectBroker(localAddres,serviceHost, listenPort,myPort);
	}
	public static ObjectBroker init(InetAddress localAddres,String serviceHost, int listenPort, boolean debug) throws IOException{
		return init(localAddres,serviceHost,listenPort,0,debug);
	}	
	public static ObjectBroker init(InetAddress localAddres,int listenPort, boolean debug) throws IOException{
		return new ObjectBroker(localAddres,listenPort);
	}
